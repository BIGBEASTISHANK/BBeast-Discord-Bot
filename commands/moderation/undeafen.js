module.exports = {
    ...
    async execute(client, message, cmd, args, Discord) {
        ...
        if(!args[0]) return message.channel.send({ embed: { color: `#00f2ff`, description: "Please Tag the person to undeafen!" } })
        ...
        try {
            ...
            message.channel.send({ embed: { color: `#00f2ff`, description: `${member} was undeafened. Now be nice.` } })
        } catch (err) {
            console.log(err)
